...
import { Mail, Lock, ArrowRight, Zap, Loader2, ShieldCheck, Home } from 'lucide-react';
...
const Register: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.response?.data?.error || 'Failed to register. Email may already be in use.');
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-[#020617] flex items-center justify-center p-4 overflow-hidden relative">
      ...
      >
        <div className="text-center mb-8 flex flex-col items-center">
          ...
          <p className="text-gray-400 text-sm mt-1">Join CodeFlow and start visualizing code</p>
        </div>
